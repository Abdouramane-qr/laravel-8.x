...
class generationController extends Controller
{
    ...
    public function post_types(Request $request)
    {
      ...
      'Current_stock' => 'required',
        ...
        $types->price = $request->price;
        $types->stockMin = $request->stockMin;
        $types->Current_stock = $request->Current_stock;
    ...
    public function single_type($id)
    {
        ...
        return view('type.page')->with('types', $types)->with('type', $type);
    }
