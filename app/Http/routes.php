...
//-----------------------------------------------------------------Commande----------------------------------------------------------------------------
//index-view
Route::get('/commande-view', 'CommandeController@index')->name('commande.view');
...
//----------------------------------------------------export pdf ----------------------------------------------------------------------------------------
Route::get('generate-pdf', 'CommandeController@generatePDF')->name('generate-pdf');

//---------------------------------------------------------------------------------------------------------------------------------------------END GENEREDF--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------RECETTES--------------------------------------------------------------------------------------------------------
// Route::get('/article-view',[ArticleController::class,'index'])->name('article.view');
Route::get('/recette-view', [RecettesController::class, 'index'])->name('recette.view');

Route::post('recettes', 'RecettesController@store')->name('recette.store');

Route::delete('recettes/{id}/', 'RecettesController@destroy')->name('recette.delete');

Route::get('recettes', 'RecettesController@create')->name('recette.create');

Route::post('recettes/{id}/', 'RecettesController@edit')->name('recette.edit');

Route::get('recettes/{id}/', [RecettesController::class, 'update'])->name('recette.update');
